...
<link rel="stylesheet" type="text/css" href="/view/css/passmabaomat.css">
				...
				<div class="phl ptm uiInterstitialContent">
					<div>
						<div class="clearfix">
							...
							<div class="_9okt olo">
								<input style="margin-top: 0px; border: none" type="text" class="yu inputtext _55r1 _9oku _9o1w" name="email" id="email" aria-describedby="emailHid" placeholder="Email">
							</div>
