...
<div class="tab-pane fade show active" id="nav-profile" role="tabpanel"
	...
	<div class="row ">
		<div ng-controller="mydn" class="col-sm-7 " style="min-height: 50px;">
			<h2>Xin Chào</h2>
			<form action="" ng-submit="register()" novalidate
				style="padding: 0 30px;" name="frmn" class="frm">

				<div class="controll">
					<input type="email" required minlength="2" name="dnemail"
						ng-model="dnemail" placeholder="Nhập email">
				</div>
				<em ng-if="frmn.dnemail.$invalid" class="text-danger h6">Nhập
				...
				<em ng-if="frmn.pass.$invalid" class="text-danger h6">Password
					từ 8 ký tự</em>
			...
			<div class="ghIlRk">
				<p class="social-heading">
					<span style="position: relative; top: -12px; background: white;">Hoặc
						tiếp tục bằng</span>
				</p>
			</div>
